...
public class ThreadDump {
  ...
  private static final Logger log = LoggerFactory.getLogger("THREAD-DUMP");

  private static final ThreadMXBean threadMXBean = ManagementFactory.getThreadMXBean();

  public static void log() {
    final String threadDump = dump();
    log.info(threadDump);
  }
  ...
  public static String dump() {
    ...
    final ThreadInfo[] threads = threadMXBean.dumpAllThreads(true, true);
